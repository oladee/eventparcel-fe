...
//         paymentTime: formData.paymentTime.toLocaleTimeString(),
//         deliveryDate: formData.deliveryDate.toISOString(),
//         deliveryTime: formData.deliveryTime.toLocaleTimeString(),
//       };
//       await axiosInstance.post("/create", submissionData);
//       setShowModal(true);
//     } catch (error) {
...
//         <div className="py-20 px-3 max-w-screen-md mx-auto h-screen overflow-y-auto">
//           <h1 className="text-2xl font-bold text-center">Payment & Delivery</h1>
//           <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow-md">
//             <div>
//               <label className="block text-sm font-medium">Payment Date</label>
//               <DatePicker selected={formData.paymentDate} onChange={(date) => handleDateChange(date, "paymentDate")} dateFormat="yyyy-MM-dd" className="w-full p-2 border rounded-lg" />
//             </div>

//             <div>
//               <label className="block text-sm font-medium">Payment Time</label>
//               <DatePicker selected={formData.paymentTime} onChange={(date) => handleDateChange(date, "paymentTime")} showTimeSelect showTimeSelectOnly timeIntervals={15} timeCaption="Time" dateFormat="hh:mm aa" className="w-full p-2 border rounded-lg" />
//             </div>

//             <div>
//               <label className="block text-sm font-medium">Delivery Date</label>
//               <DatePicker selected={formData.deliveryDate} onChange={(date) => handleDateChange(date, "deliveryDate")} dateFormat="yyyy-MM-dd" className="w-full p-2 border rounded-lg" />
//             </div>

//             <div>
//               <label className="block text-sm font-medium">Delivery Time</label>
//               <DatePicker selected={formData.deliveryTime} onChange={(date) => handleDateChange(date, "deliveryTime")} showTimeSelect showTimeSelectOnly timeIntervals={15} timeCaption="Time" dateFormat="hh:mm aa" className="w-full p-2 border rounded-lg" />
//             </div>

//             <button type="submit" className="w-full bg-blue-600 text-white py-2 rounded-lg" disabled={loading}>
//               {loading ? <BiLoaderCircle className="animate-spin inline-block mr-2" /> : "Submit"}
//             </button>
//           </form>
//         </div>
//       </section>
