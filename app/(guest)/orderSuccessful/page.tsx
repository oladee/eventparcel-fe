    ...
    <HeaderLayout>
      <div id="confirmation-container" className="rounded-xl bg-[#F9FAFB] p-4 space-y-4 mt-20">
        <div id="confirmation-content" className="flex flex-col items-center justify-between p-4 bg-[#f9fafb] h-[675px]">
          {/* Order Placed Card */}
          <div id="order-placed-card" className="bg-white rounded-2xl shadow px-6 py-4 w-full h-[253px] max-w-sm text-center">
            ...
            <p
                ...
                className="text-sm  w-full text-[#718096] font-medium mt-1 h-[66px] leading-[160%] tracking-[0px] text-center"
              >
          ...
          <div id="create-event-card" className="flex flex-col gap-[10px] h-[240px] bg-white rounded-2xl shadow p-6 w-full max-w-sm text-center">
            ...
            <h3 id="create-event-title" className="text-xl font-bold tracking-[0px] text-[#111827]">Want to create a event package like this?</h3>
            <button 
