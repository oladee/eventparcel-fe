...
const DataDeletionPolicy = () => {
  return (
    ...
    <div className="p-8 max-w-3xl mx-auto leading-relaxed font-sans mt-12">
      ...
      <p className="mb-4">If you would like to have your personal data removed from our records, please follow these steps:</p>
      <ol className="list-decimal list-inside mb-4">
        <li className="mb-2">
          <strong>Submit a Request:</strong> Send an email to <a href="mailto:your-email@example.com" className="text-blue-500 underline">your-email@example.com</a> with the subject line “Data Deletion Request”. In your email, include:
      ...
      <h2 className="text-2xl font-semibold mb-2">Data Retention and Backups</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mb-2">Consequences of Data Deletion</h2>
      <p className="mb-4">
        Please note that once your data is deleted:
      </p>
      <ul className="list-disc list-inside mb-4">
        <li className="mb-2">You will lose access to your account and any associated information.</li>
        <li className="mb-2">You may not be able to recover data that has been permanently removed.</li>
      </ul>
