...
// const integrations: Integration[] = [
//   { id:1, name:'GIGL', logo:'/logos/gigl.png', description:'Build Landing, Product Pages for more sales with 24/7 Support', connected:true },
//   { id:2, name:'Junip', logo:'/logos/junip.png', description:'Gather & display reviews (product reviews, store reviews, UGC)', connected:false },
//   { id:3, name:'Gamma', logo:'/logos/gamma.png', description:'Bring your products to Facebook and Instagram users', connected:true },
//   { id:4, name:'Dsers', logo:'/logos/dsers.png', description:'Place 100s of orders to AliExpress in seconds & Find suppliers', rating:{score:4.9,reviews:6789}, connected:false },
//   { id:5, name:'Spocket', logo:'/logos/spocket.png', description:'Drop shipping US/EU Products. Image search on Aliexpress', rating:{score:4.6,reviews:1256}, connected:false },
//   { id:6, name:'SPOD', logo:'/logos/spod.png', description:'Fastest Print-On-Demand Dropshipping in US & EU', rating:{score:4.9,reviews:2805}, connected:false },
// ]
