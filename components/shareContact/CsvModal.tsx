...
interface CsvModalProps {
  onClose: () => void;
  onValidContacts?: (contacts: Contact[]) => void;
}

const MAX_FILE_SIZE = 2 * 1024 * 1024; // 2MB limit

const CsvModal: React.FC<CsvModalProps> = ({ onClose, onValidContacts }) => {
  ...
  const handleImport = async () => {
   ...
   const handleUploadClick = () => {
    try {
      ...
      // If no contacts stored, open file picker
