...
//                     <span id="privacy" className="w-[76px] h-[22px] flex justify-center items-center px-10 py-2 rounded-[50px] font-general font-medium text-sm text-[#DE4222] border border-[#DE4222] bg-[#eadfdd]">{group.groupPrivacy.charAt(0).toLocaleUpperCase() + group.groupPrivacy.slice(1)}</span>
...
//                             }}
//                             />
//                         <span id="edit" className="font-general font-medium text-sm text-[#718096]">Edit</span>
//                     </div>
//                 </div>
