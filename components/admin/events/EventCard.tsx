...
const EventCard: React.FC<Props> = ({ image, title, date, location, sales, packagesSold }) => (
  <div className="bg-white rounded-2xl shadow overflow-hidden flex flex-col">
    <div className="relative px-4 pt-4">
      <Image src={image} alt={title} className="w-full h-40 object-cover rounded-[7px]" width={100} height={100} />
    ...
    <div className="p-4 flex-1 flex flex-col">
      <h3 className="text-lg font-bold text-[#111827] leading-tight pb-4 border-b border-[#CBD5E0]">{title}</h3>
      ...
      <div className="pt-4 flex items-center justify-between">
        ...
        <div className="border-l pl-4">
          <span className="text-[#111827] font-semibold text-lg">{packagesSold}</span>
