  ...
  return (
    <div className="rounded-[12px] border border-[#EEEFF2] w-full h-full p-4 flex flex-col gap-6">
      ...
      <div className="w-full flex" style={{ height: 300 }}>
        {/* Fixed Y-Axis */}
        <div style={{ width: 60, height: 300, background: "#fff", zIndex: 10 }}>
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart
              data={[{ sales: 0 }, { sales: max }]} // dummy data for axis
        ...
        <div
          ...
          style={{ height: 330, flex: 1 }}
        >
          <div style={{ width: chartWidth, minWidth: 600, height: 330 }}>
            <ResponsiveContainer width="100%" height="100%">
              <ComposedChart
                data={data}
                margin={{ top: 20, right: 0, left: 0, bottom: 20 }}
