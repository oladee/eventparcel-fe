...
//       <div className="bg-white w-full max-w-md rounded-t-[35px] p-5 pb-10 shadow-lg transition-transform transform translate-y-0">
//         {/* slider */}
//         <div className="w-full flex justify-center">
//           <div className="w-10 h-[6px] rounded-[1000px] bg-[#E8EAED] text-center"></div>
//         </div>

//         <div className="flex justify-between items-center mb-4">
//           <h2 className="text-lg font-bold">Event Options</h2>
//           <button onClick={onClose} className="text-xl">
//             <AiOutlineClose color="gray" />
//           </button>
//         </div>
//         <div className="grid gap-4">
//           <div className="flex justify-between items-center p-3 rounded-xl border cursor-pointer hover:bg-gray-100">
//             <div className="flex items-center">
//               <span className="p-2 bg-[#FFF7F2] rounded-full text-primary">
//                 <LuPencilLine size={20} />
//               </span>
