...
const AddGroup: React.FC<AddGroupProps> = ({ setIsAddGroupOpen, mode }) => {
    ...
    const handleBlur = (e: React.FocusEvent<HTMLInputElement | HTMLTextAreaElement>) => {
        ...
        if (value.trim() === "") {
            setErrors((prev) => ({ ...prev, [id]: `${id === "name" ? "Group name" : "Description"} is required` }));
        }
    };
    ...
    return (
        <form 
            className="w-[320px] h-auto ml-20 pl-4 space-y-8 bg-white px-5 py-6 rounded-3xl shadow-lg"
        ...
        >
            ...
            <div>
                <div className="flex justify-between">
                    ...
                    {mode === "availGroup" && (
                        <div onClick={() => setIsAddGroupOpen(false)} className="font-general text-gray-600 cursor-pointer">X</div>
                    )}
                </div>
            ...
            <div className="flex flex-col gap-2">
                ...
                {touched.name && errors.name && (
                    <p className="flex justify-start text-xs text-red-500">{errors.name}</p>
                )}
                ...
                {touched.description && errors.description && (
                    <p className="flex justify-start text-xs text-red-500">{errors.description}</p>
                )}
            </div>
            ...
            <div className="flex flex-col gap-3 mt-4">
                ...
                <div className="flex gap-14 mb-3">
                    ...
                    >
                        <Image
                            src={formData.privacy === "general" ? "/images/check.png" : "/images/unchecked.png"}
                            alt="check"
                            width={20}
                            height={20}
                        />
                    ...
                    >
                        <Image
                            src={formData.privacy === "private" ? "/images/check.png" : "/images/unchecked.png"}
                            alt="check"
                            width={20}
                            height={20}
                        />
